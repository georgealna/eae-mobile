...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( ForgotPasswordResponse forgotPasswordResponse)?  success,TResult Function( String error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
return success(_that.forgotPasswordResponse);case Error() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( ForgotPasswordResponse forgotPasswordResponse)  success,required TResult Function( String error)  error,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case Loading():
return loading();case Success():
return success(_that.forgotPasswordResponse);case Error():
return error(_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( ForgotPasswordResponse forgotPasswordResponse)?  success,TResult? Function( String error)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class Success implements ForgotPasswordState {
  const Success(this.forgotPasswordResponse);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Success&&(identical(other.forgotPasswordResponse, forgotPasswordResponse) || other.forgotPasswordResponse == forgotPasswordResponse));
}


@override
int get hashCode => Object.hash(runtimeType,forgotPasswordResponse);

@override
String toString() {
  return 'ForgotPasswordState.success(forgotPasswordResponse: $forgotPasswordResponse)';
}
...
/// Create a copy of ForgotPasswordState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? forgotPasswordResponse = null,}) {
  return _then(Success(
null == forgotPasswordResponse ? _self.forgotPasswordResponse : forgotPasswordResponse // ignore: cast_nullable_to_non_nullable
